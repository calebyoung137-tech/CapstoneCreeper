...
public class AIController
{
	...
	// Makes a copy of the provided AIController instance
	...
	public string GetBestMoveString(string state)
	{
		...
		Move bestMove;
		Minimax(4, int.MinValue, int.MaxValue, WhitePlayer, out bestMove);
	...
	private int Heuristic()
	{
		...
		// Connectivity: (Currently removed due to skepticism on impact)
